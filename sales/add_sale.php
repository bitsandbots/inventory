...
<div class="row">
  <div class="col-md-6">
    ...
    <form method="post" action="../sales/ajax.php" autocomplete="off" id="sug-form">
        <div class="form-group">
          <div class="input-group">
            <span class="input-group-btn">
              <button type="submit" class="btn btn-primary">Search</button>
            </span>
            <input type="text" id="sug_input" class="form-control" name="title"  placeholder="Product Name / SKU / Description">
         </div>
  ...
  <div class="col-md-12">
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form method="post" action="../sales/add_sale.php">
